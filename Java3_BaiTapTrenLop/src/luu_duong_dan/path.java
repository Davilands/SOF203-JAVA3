...
public void WriteToFile(String s) {
    ...
    public void save() throws IOException {
        ...
        String base64 = byteArray.toString();
        //System.out.println(base64);
        //----------------------------------------------------------
        
        System.out.println(outStreamObj.toString());
        // create the object of ByteArrayInputStream class
        // and initialized it with the byte array.
        ByteArrayInputStream inStreambj = new ByteArrayInputStream(outStreamObj.toByteArray());

        // read image from byte array
        BufferedImage newImage = ImageIO.read(inStreambj);

        // write output image
        ImageIO.write(newImage, "jpg", new File("K:\\hi.jpg"));
