...
public class Main_Form extends javax.swing.JFrame {
    ...
    public void loading(){
        ...
        try{
            for (int i=0; i<=100; i++){
                Thread.sleep(40);
                lblHideLoading.setText(Integer.toString(i)+"%");
    ...
    private void initComponents() {
        ...
        lblHideTitle.setText("THEAN BANK");
        jplHideLogin.add(lblHideTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 250, 280, 90));
        ...
        jplHideLogin.add(lblHideLoading, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, 150, 60));

        loadingbar.setBackground(new java.awt.Color(51, 51, 255));
        jplHideLogin.add(loadingbar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 430, 280, 30));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/google-plus (2).png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/facebook.png"))); // NOI18N
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/logo.png"))); // NOI18N
        ...
        jPanel1.add(lblTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 40, 130, 44));
...
//        txtPassword.setText("");
    ...
    public javax.swing.JLabel lblHideLoading;
