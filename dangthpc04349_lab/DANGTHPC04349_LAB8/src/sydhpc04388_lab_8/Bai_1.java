...
public class Bai_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbloai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "To", "CC", "BCC" }));

        btnaddfile.setText("Thêm tệp");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbltenloai, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(18, 18, 18)
    ...
    private void btnsendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsendActionPerformed
        ...
        final String password = txtpass.getText();//"kahobikljxsmvtol"
...
//            message.setFrom(new InternetAddress(txtto.getText()));
            if (cmbloai.getSelectedItem().equals("To")) {
                lbltenloai.setText("To:");
                message.setRecipients(
                        Message.RecipientType.TO,
                        InternetAddress.parse(txtto.getText())
                );
            } else if (cmbloai.getSelectedItem().equals("CC")) {
                JOptionPane.showMessageDialog(this, cmbloai.getSelectedItem());
                lbltenloai.setText("CC:");
                message.addRecipients(Message.RecipientType.CC, InternetAddress.parse(txtto.getText()));
            } else {
                lbltenloai.setText("BCC:");
                message.setRecipients(
            ...
            String body =txtSubject.getText();
            String subject=txtMessage.getText();
...
//            message.setText(txtMessage.getText());
    ...
    private void btnaddfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddfileActionPerformed
        JFileChooser f = new JFileChooser(link);
        f.setDialogTitle("Mở File");
        f.showOpenDialog(null);
        File name =f.getSelectedFile();
        link= name.getAbsolutePath();
        txtduongdan.setText(link);
