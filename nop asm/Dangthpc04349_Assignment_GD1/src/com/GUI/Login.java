...
import com.library.Extensisons.ReadQRCode;
...
public class Login extends javax.swing.JFrame {
    ...
    public void checkLogin() {
        ...
        if (txtUsername.getText().equals("")) {
            ...
            if (ketQua.equals("Nhân viên")) {
                ...
                PCManager pc = new PCManager(false, std.hightlingtName(accDAO.name(txtUsername.getText(), txtPassword.getText())));
                pc.setVisible(true);
                this.dispose();
                return;
            }
                ...
                PCManager pc = new PCManager(true, std.hightlingtName(accDAO.name(txtUsername.getText(), txtPassword.getText())));
                pc.setVisible(true);
                this.dispose();
                return;
            } else {
    ...
    private void initComponents() {
        ...
        jplLogin.add(btnHelp, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 430, 150, 30));
...
//        SetPassword setPassword = new SetPassword(true);
