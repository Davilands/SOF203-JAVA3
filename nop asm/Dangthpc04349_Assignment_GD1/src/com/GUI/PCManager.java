...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public void xetQuyen() {
        if (!this.quyenTruyCap) {
            ...
            jblTaiKhoan.setVisible(false);
            jplTaiKhoan.setVisible(false);

            //ngăn nhân viên chỉnh sửa thông tin
            txtInforCPU.setEditable(false);
            txtInforDoHoa.setEditable(false);
            txtInforGia.setEditable(false);
            txtInforHang.setEditable(false);
            txtInforHeDieuHanh.setEditable(false);
            txtInforKhoiLuong.setEditable(false);
            txtInforLuuTru.setEditable(false);
            txtInforMaSP.setEditable(false);
            txtInforManHinh.setEditable(false);
            txtInforMauSac.setEditable(false);
            txtInforPIN.setEditable(false);
            txtInforRam.setEditable(false);
            txtInforTenSP.setEditable(false);
            txtInforXuatSu.setEditable(false);
        }
    }
...
//        txtInforRole.setText(click);
    ...
    public void loadDataInforPCTable() {
        ...
        //fillToTable();
        model.setRowCount(0);
        //model.addRow(new Object[]{"fff", "ggfgf", "ggfgfgff", "ádvgff", "24", "5"});
        for (InforPC index : listInforPC) {
            //System.out.println(index.getMaSP());
    ...
    public void showDetailInforPC(int index) {
        ...
        txtInforHang.setText(listInforPC.get(index).getTenHang());
        ...
        //
        txtInforPCRecord.setText("Bảng ghi: " + (index + 1) + " trên " + listInforPC.size());
        tblInforPC.setRowSelectionInterval(index, index);
    }

    //Thương Hiệu
    public void pushPCModel() {
        listPCModel.clear();
        listPCModel.add(new PCModel("D03", "DELL"));
        listPCModel.add(new PCModel("M51", "MSI"));
        listPCModel.add(new PCModel("A5U5", "ASUS"));
        listPCModel.add(new PCModel("L3N050", "LENOVO"));
        listPCModel.add(new PCModel("H10", "HP"));
        listPCModel.add(new PCModel("L6", "LG"));
    }
    ...
    public void showDetailModel(int index) {
        txtMaHangSanXuat.setText(listPCModel.get(index).getMaHang());
        txtTenHangSanXuat.setText(listPCModel.get(index).getTenHang());

        //switchButton();
        txtModelRecord.setText("Bảng ghi: " + (index + 1) + " trên " + listPCModel.size());
    ...
    public void showDetailAccount(int index) {
        ...
        if (listAccount.get(index).isTrangThai()) {
            txtAccountTrangThai.setText("ĐANG HOẠT ĐỘNG");
            txtAccountTrangThai.setForeground(Color.green);
    ...
    private void initComponents() {
        ...
        jLabel37.setText("TÊN NGƯỜI DÙNG");
        jPanel2.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, 190, 32));
        jPanel2.add(jSeparator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 240, 26));
        ...
        jPanel2.add(txtAccountTenNguoiDung, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 210, 40));

        jLabel40.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel40.setForeground(new java.awt.Color(54, 33, 89));
        jLabel40.setText("TÊN ĐĂNG NHẬP");
        jPanel2.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 190, 32));
        jPanel2.add(jSeparator19, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 240, 26));
        ...
        jPanel2.add(txtAccountTenDangNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 200, 210, 40));
        jPanel2.add(jSeparator20, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 340, 240, 26));

        jLabel41.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel41.setForeground(new java.awt.Color(54, 33, 89));
        jLabel41.setText("MẬT KHẨU");
        jPanel2.add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 280, 190, 32));

        jLabel42.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel42.setForeground(new java.awt.Color(54, 33, 89));
        jLabel42.setText("CHỨC VỤ");
        jPanel2.add(jLabel42, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 170, 190, 32));
        jPanel2.add(jSeparator21, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 230, 210, 26));
        ...
        jPanel2.add(txtAccountChucVu, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 200, 190, 40));
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, 870, 160));
        ...
        jPanel2.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, 870, 50));
        ...
        jPanel2.add(txtAccountMatKhau, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 310, 240, 40));
        ...
        jPanel11.add(btnNew1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 110, 40));
        ...
        jPanel11.add(btnSave1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 110, 40));
        ...
        jPanel11.add(btnDelete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 110, 40));
        ...
        jPanel11.add(btnFind1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 110, 40));

        btnSort1.setBackground(new java.awt.Color(204, 204, 255));
        btnSort1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnSort1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/sort.png"))); // NOI18N
        btnSort1.setText("Sắp xếp");
        btnSort1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        btnSort1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnSort1MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnSort1MouseExited(evt);
            }
        });
        ...
        jPanel11.add(btnSort1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 110, 40));
        ...
        jPanel16.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, 870, 160));
        ...
        jLabel46.setText("Tên hãng sản xuất");
        jPanel16.add(jLabel46, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, 190, 32));
        jPanel16.add(jSeparator22, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 270, 250, 26));
        ...
        jPanel16.add(jSeparator23, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 240, 26));
        ...
        jPanel20.add(txtModelRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 230, -1));

        jPanel16.add(jPanel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, 870, 50));
        ...
        jPanel16.add(btnSort2, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 300, 180, 40));
        ...
        btnSave2.setBackground(new java.awt.Color(204, 204, 255));
        btnSave2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnSave2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/diskette.png"))); // NOI18N
        btnSave2.setText("Lưu");
        btnSave2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        ...
        jPanel16.add(btnSave2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 300, 110, 40));

        btnDelete2.setBackground(new java.awt.Color(204, 204, 255));
        btnDelete2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnDelete2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/delete.png"))); // NOI18N
        btnDelete2.setText("Xóa");
        btnDelete2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        ...
        jPanel16.add(btnDelete2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 180, 110, 40));

        btnFind2.setBackground(new java.awt.Color(204, 204, 255));
        btnFind2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnFind2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/search.png"))); // NOI18N
        btnFind2.setText("Tìm kiếm");
        btnFind2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        btnFind2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnFind2MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnFind2MouseExited(evt);
            }
        });
        ...
        jPanel16.add(btnFind2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 240, 110, 40));
        ...
        jPanel16.add(cboSort, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 190, 180, 30));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText("Sắp xếp theo: ");
        jPanel16.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 150, 100, 20));

        rdbAZ.setBackground(new java.awt.Color(255, 255, 255));
        rdbAZ.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdbAZ.setForeground(new java.awt.Color(51, 0, 204));
        rdbAZ.setText("Tăng");
        jPanel16.add(rdbAZ, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 230, 80, -1));

        rdbZA.setBackground(new java.awt.Color(255, 255, 255));
        rdbZA.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdbZA.setForeground(new java.awt.Color(0, 0, 204));
        rdbZA.setText("Giảm");
        jPanel16.add(rdbZA, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 230, 80, -1));
        ...
        jPanel3.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 100, 26));
        ...
        jPanel3.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 120, 20));
        ...
        jPanel3.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, 120, 20));
        ...
        jPanel3.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 130, 200, 20));
        ...
        jPanel3.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 300, 280, 20));
        ...
        jLabel22.setText("ĐỒ HỌA");
        jPanel3.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 320, 80, 32));
        jPanel3.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 390, 110, 20));
        ...
        jPanel3.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 390, 110, 20));
        ...
        jPanel3.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 220, 197, 20));
        ...
        jLabel26.setText("XUẤT SỨ");
        jPanel3.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 100, 32));
        jPanel3.add(jSeparator12, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, 120, 20));
        ...
        jPanel3.add(txtInforXuatSu, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 190, 110, 40));
        jPanel3.add(jSeparator13, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 390, 70, 20));
        ...
        jPanel3.add(jSeparator14, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 130, 20));
        ...
        jPanel3.add(jSeparator15, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 300, 200, 20));
        ...
        jPanel3.add(jSeparator16, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 300, 150, 20));
        ...
        jPanel3.add(jSeparator17, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 390, 60, 20));
        ...
        jPanel3.add(jSeparator18, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 390, 70, 20));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 420, 860, 120));
        ...
        jPanel7.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 110, 40));

        btnSave.setBackground(new java.awt.Color(204, 204, 255));
        btnSave.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/diskette.png"))); // NOI18N
        btnSave.setText("Lưu");
        ...
        jPanel7.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 110, 40));

        btnDelete.setBackground(new java.awt.Color(204, 204, 255));
        btnDelete.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/delete.png"))); // NOI18N
        ...
        jPanel7.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 110, 40));

        btnFind.setBackground(new java.awt.Color(204, 204, 255));
        btnFind.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnFind.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/library/icon/search.png"))); // NOI18N
        ...
        jPanel7.add(btnFind, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 110, 40));

        jPanel3.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 50, 150, 340));
        ...
        jPanel9.add(txtInforPCRecord, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 300, -1));

        jPanel3.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 540, 860, 50));
...
//        jplGiaoDich.setBackground(new Color(54, 43, 100));
    ...
    private void btnSort1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSort1MouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_btnSort1MouseEntered

    private void btnSort1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSort1MouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_btnSort1MouseExited
    ...
    private void btnFind2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnFind2MouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_btnFind2MouseEntered

    private void btnFind2MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnFind2MouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_btnFind2MouseExited
